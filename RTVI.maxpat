...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 239.0, 512.0, 128.0, 128.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 30.5, 380.0, 311.0, 279.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "1 /amp/map.2 /amp.1 /points.1/fx 0 10000 0.005 0.2 linear base 2.718282"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "1 /amp/map.1 /amp.1 /points.1/color/alpha 0 1 0.4 1 easeInBack base 2.718282"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 1.5, 212.0, 369.0, 156.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 19.333374, 259.5, 89.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 715.0, 369.5, 252.0, 155.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 0,
									"numoutlets" : 0,
									"patching_rect" : [ 24.75, 362.254059, 135.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 0,
									"numoutlets" : 0,
									"patching_rect" : [ 24.75, 308.865265, 160.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 18.75, 61.5, 172.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 0,
									"numoutlets" : 0,
									"patching_rect" : [ 24.75, 388.948456, 129.0, 20.0 ],
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 217.0, 31.0, 51.0, 18.0 ],
													"text" : "active 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "bang", "bang" ],
													"patching_rect" : [ 217.0, 9.0, 32.5, 20.0 ],
													"text" : "j.init"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 2,
													"numoutlets" : 0,
													"patching_rect" : [ 217.0, 141.0, 128.0, 23.0 ],
													"text" : "jmodel2span"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 217.0, 61.0, 128.0, 62.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 18.75, 274.737671, 303.0, 220.237686 ]
								}
...
, 			{
		...
		"parameters" : 		{
			"obj-34::obj-19" : [ "live.menu[3]", "live.menu", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "noise.view.maxpat",
