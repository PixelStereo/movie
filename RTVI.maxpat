...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 164.0, 84.5, 204.0, 28.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 78.0, 44.0, 57.0, 20.0 ],
									"text" : "adc~ 1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 9,
									"numoutlets" : 0,
									"patching_rect" : [ 78.0, 157.0, 128.0, 20.0 ],
...
,
					"patching_rect" : [ 189.510529, 331.092163, 60.0, 22.0 ],
					"presentation_rect" : [ 189.510529, 331.092163, 0.0, 0.0 ],
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 455.0, 138.0, 77.0, 20.0 ],
													"text" : "s /span/map"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 452.0, 87.0, 50.0, 18.0 ],
													"text" : "clear"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 3,
													"outlettype" : [ "", "", "" ],
													"patching_rect" : [ 72.0, 145.0, 139.0, 20.0 ],
													"text" : "j.receive /lines.1/offset/y"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "bang" ],
													"patching_rect" : [ 252.0, 100.0, 20.0, 20.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 257.0, 180.0, 50.0, 18.0 ],
													"text" : "0"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 50.0, 308.0, 532.0, 45.0 ],
													"text" : "\"/random.1/val/map.2 /random.1/val /noise.1/dim/y 0.0000 1.0000 1 10 exponential base 2.7183\" \"/random.1/val/map.3 /random.1/val /lines.1/offset/x 0.0000 1.0000 1 10 exponential base 2.7183\" \"/random.1/val/map.4 /random.1/val /lines.1/offset/y 0.0000 1.0000 10 1 exponential base 2.7183\""
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "bang" ],
													"patching_rect" : [ 191.0, 186.0, 20.0, 20.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 3,
													"outlettype" : [ "", "", "" ],
													"patching_rect" : [ 237.0, 128.0, 139.0, 20.0 ],
													"text" : "j.receive /lines.1/offset/y"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 4,
													"outlettype" : [ "", "", "", "" ],
													"patching_rect" : [ 224.0, 228.0, 182.0, 20.0 ],
													"text" : "j.remote /span/mappingmemory"
												}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 328.0, 138.0, 50.0, 18.0 ],
													"text" : "/toto 0"
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "int" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 328.0, 44.0, 20.0, 20.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 328.0, 102.0, 50.0, 18.0 ],
													"text" : "/toto $1"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 201.416626, 46.417175, 86.0, 20.0 ],
													"text" : "print TOVISCA"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 15.416626, 46.417175, 145.0, 20.0 ],
													"text" : "udpsend 10.0.0.111 8888"
												}
...
, 			{
				...
				"bootpath" : "/Users/reno/Documents/GITs/Jamoma/Implementations/Max/Jamoma/patchers/components/random",
