...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"name" : "CameraHelpModule",
					"numinlets" : 1,
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 206.0, 127.0, 320.0, 240.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 20.0, 186.0, 64.0, 20.0 ],
					"text" : "t erase b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 20.0, 254.0, 174.0, 20.0 ],
					"text" : "jit.gl.render CameraHelpModule"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 20.0, 159.0, 118.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 18.0, 127.0, 508.0, 240.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.0, 12.0, 243.0, 79.126038 ]
				}
