...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 330.0, 281.0, 100.0, 100.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 81.0, 126.0, 128.0, 72.0 ],
					"rightvalue" : 20,
					"topvalue" : 20
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 438.0, 490.041992, 46.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 43.0, 52.041992, 37.0, 20.0 ],
					"text" : "point",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 411.0, 397.041992, 50.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 169.0, 203.041992, 40.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 411.0, 425.041992, 131.0, 20.0 ],
					"text" : "j.remote mtrxctl/point/y"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 330.0, 467.041992, 50.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 101.0, 203.041992, 40.0, 20.0 ],
					"textcolor" : [ 0.060987, 0.494647, 0.768395, 1.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 330.0, 495.041992, 129.0, 20.0 ],
					"text" : "j.remote mtrxctl/point/x"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 168.5, 420.0, 150.0, 20.0 ],
					"text" : "j.remote mtrxctl/point/amp"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 168.5, 385.5, 50.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 212.0, 161.5, 50.0, 20.0 ],
					"textcolor" : [ 0.060987, 0.494647, 0.768395, 1.0 ],
					"triangle" : 0
				}
...
,
					"patching_rect" : [ 8.0, 184.0, 124.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 113.0, 154.5, 85.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 150.0, 74.0, 43.0 ],
					"setminmax" : [ 0.0, 1.0 ],
					"setstyle" : 1,
					"size" : 4,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 8.0, 154.5, 50.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 126.0, 74.0, 22.0 ],
					"rounded" : 0.0,
					"text" : "colorpicker",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 24.0, 241.0, 50.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 212.0, 203.041992, 50.0, 18.0 ],
					"text" : "reset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 24.0, 267.0, 138.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 178.0, 192.0, 252.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 40.0, 250.0, 79.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 306.0, 91.0, 124.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 306.0, 61.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 227.0, 128.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 212.0, 91.0, 86.0, 20.0 ],
					"text" : "j.remote dim/y"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 212.0, 61.0, 55.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 43.0, 203.041992, 44.0, 22.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 107.0, 91.0, 86.0, 20.0 ],
					"text" : "j.remote dim/x"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 107.0, 61.0, 55.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 203.041992, 44.0, 22.0 ],
					"triangle" : 0
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 315.5, 119.0, 292.0, 119.0, 292.0, 56.0, 315.5, 56.0 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 420.5, 454.041992, 403.5, 454.041992, 403.5, 387.041992, 420.5, 387.041992 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 116.5, 113.0, 93.0, 113.0, 93.0, 56.0, 116.5, 56.0 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 221.5, 119.0, 198.0, 119.0, 198.0, 56.0, 221.5, 56.0 ],
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 339.5, 524.041992, 322.5, 524.041992, 322.5, 457.041992, 339.5, 457.041992 ],
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 178.0, 446.0, 159.5, 446.0, 159.5, 377.0, 178.0, 377.0 ],
					"source" : [ "obj-25", 0 ]
				}
