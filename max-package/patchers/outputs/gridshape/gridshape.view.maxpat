...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 44.0, 340.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 92.0, 164.5, 40.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 44.0, 368.0, 83.0, 22.0 ],
					"style" : "",
					"text" : "j.remote layer"
				}
...
,
					"patching_rect" : [ 57.0, 208.5, 124.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 39.0, 250.0, 79.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 125.5, 100.0, 43.0 ],
					"setminmax" : [ 0.0, 1.0 ],
					"setstyle" : 1,
					"size" : 4,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 111.5, 119.5, 64.0, 22.0 ],
					"style" : "",
					"text" : "colorpicker",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 180.0, 184.5, 50.0, 22.0 ],
					"style" : "",
					"textcolor" : [ 0.060987, 0.494647, 0.768395, 1.0 ],
					"triangle" : 0,
					"tricolor" : [ 0.75, 0.75, 0.75, 1.0 ]
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 610.0, 167.0, 112.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 573.0, 80.0, 98.0, 22.0 ],
					"style" : "",
					"text" : "j.remote light"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 220.5, 121.0, 20.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 265.0, 412.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 200.564575, 164.5, 40.0, 22.0 ],
					"style" : "",
					"textcolor" : [ 0.060987, 0.494647, 0.768395, 1.0 ],
					"triangle" : 0,
					"tricolor" : [ 0.75, 0.75, 0.75, 1.0 ]
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 265.0, 440.0, 120.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 62.0, 412.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 161.5, 164.5, 40.0, 22.0 ],
					"style" : "",
					"textcolor" : [ 0.060987, 0.494647, 0.768395, 1.0 ],
					"triangle" : 0,
					"tricolor" : [ 0.75, 0.75, 0.75, 1.0 ]
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 62.0, 440.0, 120.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 104.0, 253.0, 100.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 161.5, 142.5, 79.064583, 20.0 ],
					"style" : "",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 94.0, 68.0, 87.0, 22.0 ],
					"style" : "",
					"text" : "j.remote blend"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 164.5, 79.0, 20.0 ],
					"style" : "",
					"text" : "Blend Disable",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"texton" : "Blend Enable",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 20.5, 250.0, 19.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 242.0, 107.0, 41.0, 22.0 ],
					"style" : "",
					"text" : "j.view"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 200.0, 93.0, 300.0, 70.0 ],
					"presentation" : 1,
					"presentation_rect" : [ -0.5, 0.0, 300.0, 210.0 ],
