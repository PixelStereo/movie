...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 86.0, 168.0, 252.0, 27.0 ],
					"presentation" : 1,
...
,
					"patching_rect" : [ 18.0, 127.5, 124.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 123.0, 98.0, 85.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 2.0, 146.5, 74.0, 43.0 ],
					"setminmax" : [ 0.0, 1.0 ],
					"setstyle" : 1,
					"size" : 4,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 18.0, 98.0, 50.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 2.0, 122.5, 74.0, 22.0 ],
					"rounded" : 0.0,
					"text" : "colorpicker",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 72.0, 218.041992, 37.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 18.0, 218.041992, 50.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 120.5, 146.5, 40.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 18.0, 246.041992, 84.0, 20.0 ],
					"text" : "j.remote layer"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 292.0, 99.5, 20.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 238.0, 99.5, 50.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 110.5, 169.5, 50.0, 20.0 ],
					"textcolor" : [ 0.060987, 0.494647, 0.768395, 1.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 238.0, 127.5, 67.0, 20.0 ],
					"text" : "j.remote fx"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 27.0, 50.0, 87.0, 20.0 ],
					"text" : "j.remote blend"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 27.0, 22.0, 50.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 90.0, 122.5, 74.0, 20.0 ],
					"rounded" : 0.0,
					"text" : "Blend Disable",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"texton" : "Blend Enable",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 145.5, 39.0, 252.0, 27.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 145.5, 12.0, 252.0, 27.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 145.5, 66.0, 41.0, 20.0 ],
					"text" : "j.view"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 247.5, 156.5, 230.5, 156.5, 230.5, 89.5, 247.5, 89.5 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 36.5, 72.0, 14.0, 72.0, 14.0, 18.0, 36.5, 18.0 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 27.5, 275.041992, 10.5, 275.041992, 10.5, 208.041992, 27.5, 208.041992 ],
					"source" : [ "obj-23", 0 ]
				}
